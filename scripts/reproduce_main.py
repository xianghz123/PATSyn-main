...
def parse_args():
    parser = argparse.ArgumentParser(description="Reproduce the main PATSyn experiments.")
    parser.add_argument(
        "--configs",
        nargs="+",
...
def run_command(command):
    print("[PATSyn] Running:", " ".join(str(item) for item in command))
...
def main():
    ...
    summary = {"project": "PATSyn", "mode": mode, "datasets": []}
